<%-- 
    Document   : successRefillOrder
    Created on : 15 Apr, 2017, 1:13:01 AM
    Author     : vasus
--%>
    ...
    <body id="page-top">
        ...
        <div class="col-lg-8 col-lg-offset-2 text-center">
            <div class="alert alert-success ">
                <strong>Successfully refilled. Check My orders.</strong> 
            </div>
        </div>
    <center>
        <div class="container">
            <form action="refillOrder" method="post">
                <table class="table">
                <tr>
                    <th>
                ...
                <tr>
                    ...
                    <td>
                        <center><button type="submit" value="<%= id %>" name="b1">Refill</button>
                    </td>
                </tr>
