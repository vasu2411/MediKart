<%-- 
    Document   : ordersDelivered
    Created on : 16 Apr, 2017, 10:37:11 AM
    Author     : vasus
--%>
            ...
            <form action="availableOrder" method="post">
                ...
                <%
                    ...
                    try
                    {
                        ...
                        String query = "select * from ordersretailers where retailer_uname='"+runame+"' and status='"+status+"'";
                        ResultSet rs;
                        int id;
                ...
                <tr>
                    ...
                    <td>
                       <center>
                           <img alt="prescription" width="320" height="200" src="imgDisplayDelivered?ID=<%= id %>"> 
                    </td>
                    <td>
                        <center>
                        <%
