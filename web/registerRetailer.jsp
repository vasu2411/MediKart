<%-- 
    Document   : registerRetailer
    Created on : 30 Mar, 2017, 8:54:15 PM
    Author     : vasus
--%>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <form action="insertionPendingRetailer" method="post">
                        ...
                        <div class="form-group">
                                <input type="text" class="form-control" id="addressOne" placeholder="Address" name="addressOne"><br>
                                <input type="text" class="form-control" id="addressLocality" placeholder="Locality" name="addressLocality"><br>
                                <input type="text" class="form-control" id="addressPincode" placeholder="Pincode" name="addressPincode"><br>
                                <input type="text" class="form-control" id="addressCity" placeholder="City" name="addressCity"><br>
                                <input type="text" class="form-control" id="addressState" placeholder="State" name="addressState"><br>
                                <input type="text" class="form-control" id="addressCountry" placeholder="Country" name="addressCountry">
                        </div>
                        <div class="form-group">
